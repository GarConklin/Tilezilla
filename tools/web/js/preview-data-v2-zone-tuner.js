...
import { applyUiScale, wireUiScaleListeners } from '/js/tilezilla-ui-scale.js';
...
export function initPreviewDataV2ZoneTuner(sectionKey, root = document) {
  ...
  function refreshZoneReadout() {
    ...
    els.zoneReadout.innerHTML = `
      ...
      Local artboard: ${frame.w}×${frame.h}px${frameMatch ? '' : ' (mismatch — reload preview layout)'} · tune zone in <a href="/tools/preview-v2-tuner.html">preview-v2-tuner</a>
    `;
  }
