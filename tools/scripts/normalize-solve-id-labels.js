 ...
 *
 * Usage:
 *   node tools/scripts/normalize-solve-id-labels.js
 *   node tools/scripts/normalize-solve-id-labels.js --apply --backup --file solves/5x6-0B-AEM.json
 *   node tools/scripts/normalize-solve-id-labels.js --apply --backup --limit 100
 */
