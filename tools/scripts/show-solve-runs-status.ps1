...
.EXAMPLE
  .\tools\scripts\show-solve-runs-status.ps1

.EXAMPLE
  .\tools\scripts\show-solve-runs-status.ps1 -Watch

.EXAMPLE
  .\tools\scripts\show-solve-runs-status.ps1 -Watch -IntervalSeconds 15

.EXAMPLE
  .\tools\scripts\show-solve-runs-status.ps1 -FollowLogs
#>
param(
  [string]$RepoRoot = "",
...
function Show-Status {
  ...
  Write-Host "  Refresh:  .\tools\scripts\show-solve-runs-status.ps1 -Watch"
  Write-Host "  Stop all: .\tools\scripts\stop-solve-docker-runs.ps1"
