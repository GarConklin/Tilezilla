...
.EXAMPLE
  .\tools\scripts\run-missing-solves.ps1 -DryRun

.EXAMPLE
  .\tools\scripts\run-missing-solves.ps1 -OnlySizes 4x4

.EXAMPLE
  .\tools\scripts\run-missing-solves.ps1 -LevelIds "4x4-0A-ADC,4x4-0A-ADD,4x4-0A-ADE"

.EXAMPLE
  .\tools\scripts\run-missing-solves.ps1 -OnlySizes 4x4 -FixPathMode
#>
param(
  [string]$RepoRoot = "",
