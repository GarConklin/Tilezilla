...
degree 1 (endpoint) or 2 (corridor). Branches and cycles are reported.
  ...
  python tools/scripts/audit-solution-loops.py
  python tools/scripts/audit-solution-loops.py --size 3x4
  python tools/scripts/audit-solution-loops.py --level 3x4-0B-AAA
  python tools/scripts/audit-solution-loops.py --fix --size 3x4
  python tools/scripts/audit-solution-loops.py --max-size 4x5
  python tools/scripts/audit-solution-loops.py --fix --max-size 4x5
"""
