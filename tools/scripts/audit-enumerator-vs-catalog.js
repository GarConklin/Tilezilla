 ...
 *   node tools/scripts/audit-enumerator-vs-catalog.js …
 *
 *   docker compose run --rm web node tools/scripts/audit-enumerator-vs-catalog.js
 *   docker compose run --rm web node tools/scripts/audit-enumerator-vs-catalog.js --dry-run
 *   docker compose run --rm web node tools/scripts/audit-enumerator-vs-catalog.js --max-sol 5000000 --from-size 3x4
 *   docker compose run --rm web node tools/scripts/audit-enumerator-vs-catalog.js --list-two-snake
 *
 * Restrict to certain board sizes only:
 *   docker compose run --rm web node tools/scripts/audit-enumerator-vs-catalog.js --only-sizes 3x3,3x5,5x5
 *
 * Large boards first (e.g. 6×6 down to small), skip levels already backed by solve files:
 *   docker compose run --rm web node tools/scripts/audit-enumerator-vs-catalog.js --from-size 2x4 --through-size 6x6 --reverse-size-order \
 ...
 *
 * Speed / resume:
 *   docker compose run --rm web node tools/scripts/audit-enumerator-vs-catalog.js --parallel 4
 ...
 *   docker compose run --rm web node tools/scripts/audit-enumerator-vs-catalog.js --offset 1497
 *   docker compose run --rm web node tools/scripts/audit-enumerator-vs-catalog.js --shard 0/4   # 4 terminals: 0/4 … 3/4
 *
 ...
 * Resume:
 *   docker compose run --rm web node tools/scripts/audit-enumerator-vs-catalog.js --skip-completed-log data/levels/reports/audit-enumerator-vs-catalog-progress-....ndjson
 *
