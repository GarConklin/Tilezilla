...
.EXAMPLE
  .\tools\scripts\import-catalog-to-mysql.ps1 -SyncDailyEligible
...
.EXAMPLE
  .\tools\scripts\import-catalog-to-mysql.ps1 -DryRun

.EXAMPLE
  .\tools\scripts\import-catalog-to-mysql.ps1 -LevelsOnly
#>
param(
  [string]$RepoRoot = "",
...
$pyArgs = @("tools/scripts/import-catalog-to-mysql.py")
