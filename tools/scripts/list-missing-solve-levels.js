 ...
 *
 * Usage (repo root):
 *   node tools/scripts/list-missing-solve-levels.js
 *   node tools/scripts/list-missing-solve-levels.js --json
 *   node tools/scripts/list-missing-solve-levels.js --only-sizes 4x4
 *   node tools/scripts/list-missing-solve-levels.js --ids 4x4-0A-ADC,4x4-0A-ADD
 *   node tools/scripts/list-missing-solve-levels.js --fix-path-mode --apply
 */
