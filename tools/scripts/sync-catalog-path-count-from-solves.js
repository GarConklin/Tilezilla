 ...
 *
 *   node tools/scripts/sync-catalog-path-count-from-solves.js --apply
 *   node tools/scripts/sync-catalog-path-count-from-solves.js --apply --ids 5x6-0B-AWL,5x6-0B-AWM
 */
