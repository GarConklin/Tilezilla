...
.EXAMPLE
  ...
  .\tools\scripts\run-enumerate-levels.ps1 -LevelIds "5x6-0B-AUY" -SyncCatalog

.EXAMPLE
  .\tools\scripts\run-enumerate-levels.ps1 -LevelIds "5x6-0B-AUY,5x6-0B-AUZ,5x6-0B-AVA" -SyncCatalog
