...
Requires pymysql and MYSQL_* env (host mysql from web container, 127.0.0.1 from host).
  ...
  python tools/scripts/import-catalog-to-mysql.py
  python tools/scripts/import-catalog-to-mysql.py --dry-run
  python tools/scripts/import-catalog-to-mysql.py --levels-only
"""
