...
.DESCRIPTION
  Prefer .\tools\scripts\import-adventure-map.ps1 with data/adventure_solution_distribution.csv
...
.EXAMPLE
  .\tools\scripts\import-adventure-progression.ps1
#>
param(
  [string]$RepoRoot = "",
...
$pyArgs = @("tools/scripts/import-adventure-progression.py", "--csv", ($Csv -replace '\\', '/'))
