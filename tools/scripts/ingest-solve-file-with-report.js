 ...
 * Usage: node tools/scripts/ingest-solve-file-with-report.js <batch.txt> [--dry-run]
 */
...
function main() {
  ...
  if (!fileArg) {
    console.error('Usage: node tools/scripts/ingest-solve-file-with-report.js <batch.txt> [--dry-run]');
    process.exit(1);
  }
