 ...
 *
 * Usage:
 *   node tools/scripts/merge-solve-docs-append.js <concatenated-json.txt>
 *   node tools/scripts/merge-solve-docs-append.js --dry-run <file>
 */
...
function main() {
  ...
  if (!file) {
    console.error('Usage: node tools/scripts/merge-solve-docs-append.js [--dry-run] <concatenated-json.txt>');
    process.exit(1);
  }
