 ...
 * Usage: node tools/scripts/validate-0c-ingested.js [5x6-0C-AAL ...]
 */
'use strict';
...
const { validateCompleteLayout } = require(path.join(ROOT, 'tools/scripts/validate-complete-layout.js'));
