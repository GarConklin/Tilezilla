...
cd /opt/tilezilla
git pull
chmod +x scripts/weekly-restart-production.sh scripts/install-production-weekly-restart.sh
...
This is **not** a full host reboot — just clears bogged app containers.
