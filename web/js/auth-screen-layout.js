...
export const AUTH_SCREEN_DEFS = {
  login: {
    ...
    items: {
      ...
      forgotPassword: { label: 'Forgot password (?)', kind: 'hit', cssClass: 'auth-screen__hit--forgot-password', baseClass: 'auth-screen__hit' },
...
export const DEFAULT_AUTH_SCREEN_LAYOUT = {
  login: {
    ...
    items: {
      ...
      forgotPassword: { x: 58, y: 34.2, w: 9, h: 4.2 },
