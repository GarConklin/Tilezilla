...
export const RECORDS_ITEM_DEFS = {
  ...
  colRankName: { cssKey: 'col-rank-name', kind: 'col', label: 'Adv LB — level name', screens: ['adventure'] },
  colSubLevel: { cssKey: 'col-sub-level', kind: 'col', label: 'Adv LB — sublevel', screens: ['adventure'] },
