...
Write-Host "  2. .\scripts\build-game-bundle.ps1   # production runtime folder for VPS"
Write-Host "  3. scp -r deploy-export\<stamp>\game user@your-server:/opt/tilezilla/"
Write-Host "  4. scp -r" $OutDir "user@your-server:/opt/tilezilla/deploy-import/   # SQL only"
Write-Host "  5. On server: see Docs/deploy-ubuntu.md and game/README.md"
Write-Host ""
